...
"kaifeng",
   ...
   ###获取区下面的各个县的url
    def parse(self, response):
        ...
        for i in links:
            ...
            yield Request(i.url, callback=self.get_index, meta={'city_name':city_name,'dont_redirect':True},dont_filter=True)
    ...
    def get_index(self, response):
        ...
        for i in links:
            ...
            yield Request(i.url, callback=self.get_message, meta={'city':city,'city_name': city_name,'download_timeout': 10,'dont_redirect':True},dont_filter=True)
   ...
   ####解析详情页
    def get_message(self, response):
        ...
        yield  Request(url,callback=self.get_phone,meta={'item':item,'download_timeout': 10,'dont_redirect':True},dont_filter=True)
